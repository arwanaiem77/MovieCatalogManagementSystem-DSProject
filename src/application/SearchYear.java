...
public class SearchYear extends Pane {

	public SearchYear(Stage primaryStage,Scene oldScene) {
		...
		Label l =new Label(" Realese Year : ");
		...
		search.setOnAction(a ->{
			...
			list = Movie.movieList.getYear(Integer.parseInt(tf.getText()));
